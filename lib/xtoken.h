...
/* DC4 */  xx(CREM,      20,  2, OP_MOD,  tree_bit,  '=',          "%=",                 2)
/* NAK */  xx(CBAND,     21,  2, OP_BAND, tree_bit,  '=',          "&=",                 2)
/* SYN */  xx(CMUL,      22,  2, OP_MUL,  tree_mul,  '=',          "*=",                 2)
/* ETB */  xx(CADD,      23,  2, OP_ADD,  tree_add,  '=',          "+=",                 2)
/* CAN */  xx(CSUB,      24,  2, OP_SUB,  tree_sub,  '=',          "-=",                 2)
/* EN  */  xx(CDIV,      25,  2, OP_DIV,  tree_mul,  '=',          "/=",                 2)
/* SUB */  xx(CRSHFT,    26,  2, OP_RSH,  tree_sh,   '=',          ">>=",                2)
/* ESC */  xx(CLSHFT,    27,  2, OP_LSH,  tree_sh,   '=',          "<<=",                2)
/* FS  */  xx(CBXOR,     28,  2, OP_BXOR, tree_bit,  '=',          "^=",                 0)
/* GS  */  xx(CBOR,      29,  2, OP_BOR,  tree_bit,  '=',          "|=",                 2)
