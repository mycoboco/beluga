...
int x2[1]; void f2(void) { int x2; { extern int x2[2]; } }                         /* warning */
void f3_1(void) { extern int x3[1]; } void f3_2(void) { extern int x3[2]; }        /* warning */
void f4(void) { extern int x4[1]; extern int x4[]; } extern int x4[2];             /* warning */
void f5(void) { extern int x5[1]; { extern int x5[]; } } extern int x5[2];         /* warning */
extern int x6[10]; void f6(void) { long double *x6[2]; { extern int x6[11]; } }    /* warning */
...
int x8_9[]; void f8(void) { long double *x8_9[2]; { extern int x8_9[2]; } }
            void f9(void) { long double *x8_9[2]; { extern int x8_9[3]; } }        /* warning */
extern int x10_11[10]; void f10_11(void) {
    extern int x10_11[]; { char x10_11; { extern int x10_11[11]; } } }             /* warning */
...
int x19_20[]; void f19_20_1(void) { extern int x19_20[10]; }
              void f19_20_2(void) { extern int x19_20[11]; }                       /* warning */
void f21_22_1(void) { extern int x21_22[10]; } int x21_22[];
void f21_22_2(void) { extern int x21_22[11]; }                                      /* warning */
static int x23_24;
