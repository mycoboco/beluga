...
auto int x3;        /* error */
register int x4;    /* error */
enum { x5 }; int x5;    /* redeclaration of x5 */
int x6[]; int x6[10]; void f(void) { int (*p)[10], (*q)[11], (*r)[]; p = &x6; q = &x6; r = &x6; }    /* error */
...
void g2(void) { extern int x14_15[]; } extern int x14_15[11];    /* warning */
void h1(void) { extern int x16_17_18[]; }
void h2(void) { extern int x16_17_18[10]; }
void h3(void) { extern int x16_17_18[11]; }                      /* warning */
int x19(void) = 0;    /* error */
static int x20[];    /* error */
