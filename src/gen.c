...
ssz_t gen_off, gen_maxoff;      /* offset and max offset for locals */
ssz_t gen_aoff, gen_maxaoff;    /* offset and max offset for arguments */
ssz_t gen_frame;                /* frame size */
 ...
 */
ssz_t (gen_arg)(ssz_t size, int align)
{
    ssz_t aoff = gen_aoff;
