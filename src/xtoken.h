...
/* 134 */  xx(CREM,     134,  2, 0,       0,           0,            "%=",                 2)
/* 135 */  xx(CBAND,    135,  2, 0,       0,           0,            "&=",                 2)
/* 136 */  xx(CMUL,     136,  2, 0,       0,           0,            "*=",                 2)
/* 137 */  xx(CADD,     137,  2, 0,       0,           0,            "+=",                 2)
/* 138 */  xx(CSUB,     138,  2, 0,       0,           0,            "-=",                 2)
/* 139 */  xx(CDIV,     139,  2, 0,       0,           0,            "/=",                 2)
/* 140 */  xx(CRSHFT,   140,  2, 0,       0,           0,            ">>=",                2)
/* 141 */  xx(CLSHFT,   141,  2, 0,       0,           0,            "<<=",                2)
/* 142 */  xx(CBXOR,    142,  2, 0,       0,           0,            "^=",                 2)
/* 143 */  xx(CBOR,     143,  2, 0,       0,           0,            "|=",                 2)
/* 144 */  xx(PPNUM,    144,  0, 0,       0,           0,            "pp-number",          3)
/* 145 */  xx(HEADER,   145,  0, 0,       0,           0,            "header name",        0)
/* 146 */  xx(UNKNOWN,  146,  0, 0,       0,           0,            "unknown token",      3)
#endif    /* SEA_CANARY */
